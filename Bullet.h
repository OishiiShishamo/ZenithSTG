...
void CreateSimpleBulletGroup(Vec2D pos, Color color, int style, int blend, int pal, double colSize, double size, int way, double spread, int aim, double angle, double speed);
void MoveBullets();
