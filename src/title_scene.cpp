...
namespace zenithstg {
	void TitleScene::Update() {
		...
		MoveParticles();
		DrawFormatStringToHandle(kCenterX - GetDrawFormatStringWidthToHandle(SafeAccess(font_types, kFontUi1), "Pless Enter Key.") / 2, kCenterY + 256, Color(kColorWhite).GetDxColor(), SafeAccess(font_types, kFontUi1), "Pless Enter Key.");
